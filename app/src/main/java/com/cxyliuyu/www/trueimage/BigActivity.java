...
public class BigActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        topLeftImageview = (ImageView)findViewById(R.id.big_top_left);
        topRightImageview = (ImageView)findViewById(R.id.big_top_right);
        topCenterImageview = (ImageView)findViewById(R.id.big_top_center);
        bottomLeftImageview = (ImageView)findViewById(R.id.big_tab_home_icon);
        bottomRightImageview = (ImageView)findViewById(R.id.big_tab_me_icon);
        bottomCenterImageview = (ImageView)findViewById(R.id.big_tab_work_icon);
        commonImageview1 = (ImageView)findViewById(R.id.big_common1);
        commonImageview2 = (ImageView)findViewById(R.id.big_common2);
        refreshButton = (Button)findViewById(R.id.big_refresh_button);
    ...
    private void refreshView(){
        String dicPath = Environment.getExternalStorageDirectory().getPath()+"/TrueImage/big/";
